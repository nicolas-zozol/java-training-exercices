		...
		if (me.getClassifier().getValue()>him.getClassifier().getValue())
			...
			if (me.getLevelValue()>him.getLevelValue())
				...
				if (me.getSecondLevel()>him.getSecondLevel())
					...
					TreeSet<Card> mySingleCards= me.getSingleCards();
					TreeSet<Card> hisSingleCards= me.getSingleCards();
					Iterator<Card> myIterator= mySingleCards.iterator();
					Iterator<Card> hisIterator= hisSingleCards.iterator();
					boolean areEquals = true;
					while (areEquals){
						if (myIterator.hasNext()){
							Card myCard = myIterator.next();
							Card hisCard =  hisIterator.next();
							
					//		myCard.compareValue(o)
						}
